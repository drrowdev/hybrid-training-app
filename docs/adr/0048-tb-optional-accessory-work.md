...
Status: Superseded by [ADR 0075](0075-tb-user-chosen-accessories.md)
(2026-08-23) — accessories are now chosen by the user in the session editor, for
Green Protocol as well as Tactical Barbell. The injector this ADR describes still
runs for blocks deployed before that, and the accessory DOSE it derived (8–15
reps, near failure) is what a user-added movement is prescribed at. Originally:
Accepted (2026-06-13) — platform layer implemented in #496
Supersedes: none
