...
| [`ai-roadmap.md`](./ai-roadmap.md) | **Deferred Wendler-port items.** 8 features audited from the user's Wendler 5/3/1 app and parked for a later wave (#9 /races, #10 /injuries, #11 Training Profile, #12 calendar view modes, #13 phase auto-shift, #14 "what is this?" inline help, #15 AMRAP→e1RM vs entered 1RM, #16 TAPER auto-detection with Accept/Dismiss). Each item: rationale, current gap, UX sketch, dependencies. Build-order recommendation at the bottom. Created 2026-05-23 after the cross-app audit. |
