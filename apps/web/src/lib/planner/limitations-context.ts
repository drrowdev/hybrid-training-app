 ...
 *     resolve it. Created via the "Quickly block a region" control or
 *     the full add-limitation form on /app/recovery/injuries.
 *
 ...
 *     family) — e.g. a "Achilles tendinopathy" row added via the
 *     /app/recovery/injuries form activates the flag.
 *
