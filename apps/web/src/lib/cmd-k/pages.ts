...
export const STATIC_PAGES: PaletteItem[] = [
  ...
  { id: "page-plan", kind: "page", title: "Schedule", subtitle: "All workouts", href: "/app/plan", icon: "▦" },
  { id: "page-plan-history", kind: "page", title: "Plan — History", subtitle: "Past + archived programs", href: "/app/plan/history", icon: "▦" },
  { id: "page-plan-new", kind: "page", title: "New program", subtitle: "Choose a program type", href: "/app/program/build", icon: "＋" },
  { id: "page-program", kind: "page", title: "Program templates", subtitle: "Choose a training template", href: "/app/program", icon: "＋" },
  ...
  { id: "page-stats-blocks", kind: "page", title: "Stats — Programs", subtitle: "Program analytics", href: "/app/stats/blocks", icon: "▲" },
  ...
  { id: "page-stats-engine", kind: "page", title: "Stats — Recovery", subtitle: "Recovery and training load", href: "/app/stats/engine", icon: "▲" },
  ...
  { id: "page-settings-events", kind: "page", title: "Events", subtitle: "Races, comps, meets — priority events", href: "/app/settings/events", icon: "◆" },
