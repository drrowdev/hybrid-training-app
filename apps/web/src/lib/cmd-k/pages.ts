...
export const STATIC_PAGES: PaletteItem[] = [
  ...
  { id: "page-stats-blocks", kind: "page", title: "Stats — Blocks", subtitle: "Block analytics", href: "/app/stats/blocks", icon: "▲" },
  ...
  { id: "page-stats-engine", kind: "page", title: "Stats — Engine", subtitle: "Region freshness + decision trace", href: "/app/stats/engine", icon: "▲" },
