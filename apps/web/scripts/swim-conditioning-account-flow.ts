...
import { todayConditioningAccountProfile, checkConditioningAccountDispatch,
  conditioningAccountAbsenceQuery, verifyConditioningContextRequests } from "../../../packages/db/scripts/swim-conditioning-account-flow-guards";
...
export const CONDITIONING_ACCOUNT_FLOW = todayConditioningAccountProfile();
const configuration: AccountFlowConfiguration = {
  ...
  validateRequests: verifyConditioningContextRequests,
};
