-- Restore the exact 0145 definitions before removing the private identity helper.
-- This restores the known prior access limitation, not an operational guarantee.
BEGIN;
...
DROP FUNCTION public.swim_request_user_id() RESTRICT;
COMMIT;
