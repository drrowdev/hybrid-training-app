...
const SQUAT: NewMovement[] = [
  ...
  squat("goblet-squat", "Goblet Squat", { equipment: "dumbbell-or-kb", axialLoad: "moderate", stability: "supported", experienceMax: 2 }),
...
const HINGE: NewMovement[] = [
  ...
  hinge("single-leg-rdl", "Single-Leg RDL", { equipment: "dumbbell-or-kb", bilateral: false, axialLoad: "moderate", primaryMuscles: ["hamstrings", "glutes"], secondaryMuscles: ["abductors"], experienceMin: 2 }),
  ...
  hinge("seated-good-morning", "Seated Good Morning", { equipment: "barbell", primaryMuscles: ["lower_back", "hamstrings"], experienceMin: 2 }),
  ...
  hinge("kb-swing-russian", "Russian KB Swing", { equipment: "kettlebell", primaryMuscles: ["glutes", "hamstrings"], secondaryMuscles: ["lower_back", "abs"], axialLoad: "moderate", experienceMax: 2 }),
...
const PRESS: NewMovement[] = [
  ...
  press("db-bench-flat", "DB Bench Press (flat)", { equipment: "dumbbells-bench", experienceMax: 2 }),
  ...
  press("z-press", "Z-Press", { equipment: "barbell-floor-seated", primaryMuscles: ["front_delts", "triceps", "abs"], axialLoad: "high", experienceMin: 2 }),
];
...
const PULL: NewMovement[] = [
  ...
  pull("db-row-single-arm", "Single-Arm DB Row", { equipment: "dumbbell-bench", bilateral: false, stability: "supported", experienceMax: 2 }),
  ...
  pull("meadows-row", "Meadows Row", { equipment: "landmine", bilateral: false, primaryMuscles: ["lats", "mid_back"], experienceMin: 2 }),
