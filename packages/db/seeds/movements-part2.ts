...
const TRICEPS: NewMovement[] = [
  ...
  triceps("jm-press", "JM Press", { equipment: "barbell-bench", primaryMuscles: ["triceps", "chest"], isCompound: true }),
...
const LEG_ISO: NewMovement[] = [
  ...
  legIso("nordic-ham-curl", "Nordic Ham Curl", { equipment: "bodyweight-anchor", primaryRegion: "hamstring_posterior", primaryMuscles: ["hamstrings"], highStrainTendon: true, stability: "free", metadata: { eccentric_cost: "very_high", emphasis: "hamstring-strain-prevention" } }),
  ...
  legIso("copenhagen-plank", "Copenhagen Plank", { equipment: "bench", primaryMuscles: ["adductors", "abs", "obliques"], primaryRegion: "adductor_groin", stability: "free", metadata: { protocol: "isometric" } }),
...
const CORE: NewMovement[] = [
  ...
  core("ab-wheel-standing", "Ab Wheel (standing)", { equipment: "ab-wheel", primaryMuscles: ["abs", "lats"] }),
  ...
  core("dragon-flag", "Dragon Flag", { equipment: "bench", primaryMuscles: ["abs", "lower_back"] }),
